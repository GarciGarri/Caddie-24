...
const DEMO_MESSAGES: Record<string, DemoMessage[]> = {
  "demo-conv01": [
    { id: "dm01-1", conversationId: "demo-conv01", whatsappMessageId: "wam01-1", direction: "INBOUND", type: "TEXT", content: "Hola, buenos días! Quería preguntar por disponibilidad para el sábado", status: "READ", isAiGenerated: false, timestamp: h(48), mediaUrl: null, templateName: null, aiDraft: null, sentBy: null, deliveredAt: null, readAt: null },
    { id: "dm01-2", conversationId: "demo-conv01", whatsappMessageId: "wam01-2", direction: "OUTBOUND", type: "TEXT", content: "Hola Carlos! Claro, el sábado tenemos disponibilidad a las 8:00, 9:00, 10:30 y 12:00. Qué horario te viene mejor?", status: "READ", isAiGenerated: true, timestamp: h(47.9), mediaUrl: null, templateName: null, aiDraft: null, sentBy: null, deliveredAt: h(47.9), readAt: h(47) },
    { id: "dm01-3", conversationId: "demo-conv01", whatsappMessageId: "wam01-3", direction: "INBOUND", type: "TEXT", content: "A las 9:00 estaría perfecto. Somos 3 jugadores", status: "READ", isAiGenerated: false, timestamp: h(46), mediaUrl: null, templateName: null, aiDraft: null, sentBy: null, deliveredAt: null, readAt: null },
  ...
  "demo-conv02": [
    ...
    { id: "dm02-2", conversationId: "demo-conv02", whatsappMessageId: "wam02-2", direction: "OUTBOUND", type: "TEXT", content: "Hola María! Sí, el Torneo de Primavera 2026 es el 15 de abril. Es un Stableford individual con inscripción de 35 euros. Hay premios en 3 categorías. ¿Quieres que te inscriba?", status: "READ", isAiGenerated: true, timestamp: h(71.9), mediaUrl: null, templateName: null, aiDraft: null, sentBy: null, deliveredAt: h(71.9), readAt: h(71) },
  ...
  "demo-conv03": [
    ...
    { id: "dm03-2", conversationId: "demo-conv03", whatsappMessageId: "wam03-2", direction: "OUTBOUND", type: "TEXT", content: "Hola Fernando! Buenos días. ¿En qué puedo ayudarte?", status: "READ", isAiGenerated: true, timestamp: h(5.9), mediaUrl: null, templateName: null, aiDraft: null, sentBy: null, deliveredAt: h(5.9), readAt: h(5) },
  ...
  "demo-conv07": [
    ...
    { id: "dm07-3", conversationId: "demo-conv07", whatsappMessageId: "wam07-3", direction: "INBOUND", type: "TEXT", content: "Sí! El jueves a las 10:00 me va genial", status: "READ", isAiGenerated: false, timestamp: h(69), mediaUrl: null, templateName: null, aiDraft: null, sentBy: null, deliveredAt: null, readAt: null },
